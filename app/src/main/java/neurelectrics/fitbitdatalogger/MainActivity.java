...
public class MainActivity extends AppCompatActivity {
    ...
    int MAX_STIM=2000;
    float CUE_NOISE_OFFSET=0.00f; //how much louder is the cue than the white noise
    float CUE_NOISE_MAX=0.00f; //how much louder can the cues get than white noise
    float MAX_ADAPTION_STEP=0.015f; //If cues seem to trigger a wakeup, drop the max volume we can reach by this much
    long ONSET_DELAY=30*60*1000; //minimumj delay before cues start
    ...
    private void getUserSettings(){
        new Thread(new Runnable() {
            public void run() {
                ...
                String settingsDataLink = "https://raw.githubusercontent.com/larryyuencheng/motor-tmr-settings/main/settings.txt";

 ...
 * @since 2.0.0
 */
export declare const foldLeft: <A, B>(onNil: Lazy<B>, onCons: (head: A, tail: Array<A>) => B) => (as: Array<A>) => B
/**
 ...
 * @since 2.0.0
 */
export declare const foldRight: <A, B>(onNil: Lazy<B>, onCons: (init: Array<A>, last: A) => B) => (as: Array<A>) => B
/**

...
var mapWithIndex_ = function (fa, f) { return fa.map(function (a, i) { return f(i, a); }); };
var ap_ = function (fab, fa) { return flatten(map_(fab, function (f) { return map_(fa, f); })); };
var chainWithIndex_ = function (fa, f) {
    var outLen = 0;
    var l = fa.length;
...
var chain_ = function (fa, f) {
    return chainWithIndex_(fa, function (_index, a) { return f(a); });
};
var filterMap_ = function (as, f) { return filterMapWithIndex_(as, function (_, a) { return f(a); }); };
...
var alt_ = function (fa, that) { return concat(fa, that()); };
...
var extend_ = function (fa, f) { return fa.map(function (_, i, as) { return f(as.slice(i)); }); };
...
var traverseWithIndex_ = function (F) { return function (ta, f) {
    return reduceWithIndex_(ta, F.of(exports.zero()), function (i, fbs, a) {
 ...
 * @since 2.7.0
 */
exports.chainWithIndex = function (f) { return function (ma) { return chainWithIndex_(ma, f); }; };
/**
 ...
 * @since 2.5.0
 */
exports.chainFirst = function (f) { return function (ma) { return chain_(ma, function (a) { return map_(f(a), function () { return a; }); }); }; };
/**
 * @category Extend
 * @since 2.5.0
 */
 ...
 * @since 2.5.0
 */
exports.compact = function (as) { return filterMap_(as, function_1.identity); };
/**
 * @category Compactable
 * @since 2.5.0
 */
 ...
 * @since 2.5.0
 */
exports.filterMapWithIndex = function (f) { return function (fa) { return filterMapWithIndex_(fa, f); }; };
/**
 * @category FilterableWithIndex
 * @since 2.5.0
 */
 ...
 * @since 2.5.0
 */
exports.reduceRightWithIndex = function (b, f) { return function (fa) { return reduceRightWithIndex_(fa, b, f); }; };
/**

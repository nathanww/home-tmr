...
function scaffoldDirectory(scaffold) {
    const scaffoldPath = path_1.default.join(__dirname, '..', 'scaffold', scaffold);
...
async function newProject() {
    ...
    const { appType, appDisplayName, withCompanion, withSettings, enabledBuildTargets, } = await inquirer_1.default.prompt([
        {
            name: 'appType',
            type: 'list',
            choices: Object.values(ProjectConfiguration_1.AppType),
    ...
    packageJSON.fitbit = Object.assign(Object.assign({}, config), { appType,
        appDisplayName, appUUID: uuid_1.default.v4(), buildTargets: enabledBuildTargets, wipeColor: '#ffffff' });
    packageJSON.scripts = {
        build: 'fitbit-build',
        debug: 'fitbit',
    };
